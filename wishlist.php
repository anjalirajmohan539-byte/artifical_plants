...
<div class="container wishlist">
    <?php
    $select = "SELECT ap.`Id`, wl.Id AS wishlistId, `ProductImage`, `ProductName`,ap.`Price`, off.DiscountValue, pc.Categorys AS `CategoryId`, wl.CreateDate, ct.Status,
...
?>
    ...
    <?php } ?></td>
                ...
                <td>
                <button class="wooden-cart-button" title="Add To Cart" <?php if($details['Status'] != 0){echo "disabled";}?>>
