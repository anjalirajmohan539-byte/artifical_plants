...
<!-- MAIN CONTENT -->
<div class="wrapper">
    <div class="title">Discount Types Details</div>

    <div class="grid-container">

        <!-- Left Card (Form) -->
        <div class="card">
            <h3 style="margin-bottom: 15px;">Add Discount Types</h3>
            <form action="discount_type_action.php" method="post" id="productForm" autocomplete="off">
            <label>Discount Types <s>*</s></label>
            <input type="text" id="DiscountTypes" name="DiscountTypes" value="" placeholder="Enter Discount name" oninput="clearError('colorErr')">
        ...
        <div class="table-card">
            <table>
                ...
                <?php
                $select="SELECT `Id`, `Name` FROM `discount_type` WHERE IsDeleted = 0";
                ...
                {
                    while($discount = mysqli_fetch_assoc($check))
                    {
