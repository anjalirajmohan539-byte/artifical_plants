...
if (isset($_POST['btn'])) {
    ...
    $charge      = empty($_POST['deliveryCharge']) ? 0 : $_POST['deliveryCharge'];
    $type        = $_POST['type'];
    ...
    $insert = "INSERT INTO shipping_details
               (ProductId, AvailabilityId, DeliveryDays, DeliveryType, Deliverycharge)
